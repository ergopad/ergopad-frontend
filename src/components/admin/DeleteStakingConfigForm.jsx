      ...
      <Box component="form" onSubmit={handleSubmit}>
        ...
        <Grid item xs={12}>
          <Typography color="text.secondary" sx={{ mt: 2, mb: 1 }}>
            Enter config id manually or select a project from the table below.
            This is an irreversible action. All details will be deleted and
...
export default DeleteStakingConfigForm;

      ...
      <Box component="form" onSubmit={handleSubmit}>
        ...
        <Grid item xs={12}>
          <Typography color="text.secondary" sx={{ mt: 2, mb: 1 }}>
            Enter job id manually or select a job from the table below. This is
            an irreversible action. All job details will be deleted and cannot
            be recovered afterwards. It is recommended to archive listings

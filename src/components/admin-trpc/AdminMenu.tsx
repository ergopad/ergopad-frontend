...
const links = {
  Projects: [
    // {
    //   name: 'Create Project',
    //   link: '/admin-trpc/create-project'
    // },
    // {
    //   name: 'Edit Project',
    //   link: '/admin-trpc/edit-project'
    // },
    {
      name: 'Contribution Rounds',
      link: '/admin-trpc/contribution-rounds'
    }
  ],
  Reports: [
    {
      name: 'Transaction Reports',
      link: '/admin-trpc/transaction-report'
    }
  ],
  // Other: [
  //   {
  //     name: 'Hero Carousel',
  //     link: '/admin-trpc/hero-carousel'
  //   },
  //   {
  //     name: 'Whitelist Review',
  //     link: '/admin-trpc/whitelist'
  //   }
  // ]
}

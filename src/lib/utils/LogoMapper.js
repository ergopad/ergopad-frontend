...
export const ASSET_URL =
  'https://raw.githubusercontent.com/capt-nemo429/nautilus-wallet/master/public/icons/assets'
const MAPPER =
...
const getRawNautilusAddressMapper = async () => {
  try {
    if (localStorage.getItem(ADDRESS_MAPPER_STORAGE_KEY)) {
      const res = JSON.parse(localStorage.getItem(ADDRESS_MAPPER_STORAGE_KEY))

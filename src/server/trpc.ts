...
/**
 * Reusable middleware that enforces user has admin privelages in before running the
 * procedure.
 */
 ...
 *
 * This verifies that the user has isAdmin set to true in the database when
 * they logged in.
 *
 * @see https://trpc.io/docs/procedures
 */

...
const Apply = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (errorCheck) {
      axios
        .post(`${process.env.API_URL}/util/email`, {
          ...defaultOptions,
          ...form,
        })
        .then((res) => {
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    formErrors.projectName && 'Enter the project name'
                  }
                />
              </Grid>
              <Grid item xs={12}>
                <Typography color="text.secondary" sx={{ mb: 1 }}>
                  Please describe what your project hopes to accomplish, and how
                  far along you are. Give us some details about your team
                  composition including everyone&apos;s roles and specialties.
                  Provide as much detail as you can about what you need from us
                  and how much progress you&apos;ve made already.
                </Typography>
                <TextField
                  InputProps={{ disableUnderline: true }}
                  required
                  ...
                  helperText={
                    formErrors.description && 'Enter the project description'
                  }
                  rows={6}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    ...
                    'Please provide an estimation, even if it may change later'
                  }
                />
              </Grid>
              <Grid item xs={12}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  helperText={
                    formErrors.telegramHandle && 'Enter your Telegram handle'
                  }
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  helperText={
                    formErrors.telegramGroup &&
                    "Enter your project's Telegram group"
                  }
                />
              </Grid>
            </Grid>

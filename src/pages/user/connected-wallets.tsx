    ...
    <>
      ...
      >
        {loading ? (
          ...
          <Box sx={{ textAlign: 'center' }}>
            <Typography>Sign in to view connected wallets</Typography>
          </Box>
        ) : (
          sortedWallets && (
                  ...
                  <Grid xs={12} sm={6} md={4} key={`wallet-${i}`}>
                    <Paper sx={{ p: 2, height: '100%', minHeight: '250px' }}>
                        ...
                        <Box>
                          <Typography variant="h5" sx={{ mb: 0 }}>
                            {wallet.changeAddress ===
                              sessionData?.user?.address && 'Default '}
                            Wallet {i + 1}
                          </Typography>
                        ...
                        <Box sx={{ mr: -1 }}>
                          {removeLoading === i ? (
                            ...
                            wallet.changeAddress !==
                              ...
                              <IconButton
                                onClick={() => removeItem(wallet.id, i)}
                              >
                                <DeleteOutlineIcon />
                              </IconButton>
                            )
                      ...
                      <TextField
                        ...
                        disabled
                        InputProps={{
                          startAdornment: wallet.changeAddress ===
                            sessionData?.user?.address && (
                          ...
                          return (
                            ...
                            >
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  handleDefaultAddressChange(wallet.id, address)
                                }
                              >
                                {wallet.changeAddress === address ? (
                                  'Active'

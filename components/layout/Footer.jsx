          ...
          <MuiNextLink activeClassName="active" href="/">
            <IconButton sx={{ mb: '2rem' }}>
              ...
              >
                ...
                <polygon
                  points="27.3 4.7 16 0 4.7 4.7 0 16 7.8 16 10.2 10.2 16 7.8 21.8 10.2 24.2 16 32 16"
                  fill="url(#b)"
                />
                <linearGradient
                  id="a"
                ...
                <polygon
                  points="24.2 16 21.8 21.8 16 24.2 10.2 21.8 7.8 16 0 16 4.7 27.3 16 32 27.3 27.3 32 16"
                  fill="url(#a)"
                />
              </svg> */}
            </IconButton>
          ...
          <List>
            ...
            {dynamicWhitelistFooters.map((event) => (
              <ListItem key={event.id} disableGutters sx={listItemStyles}>
                <Link
                  activeClassName="active"
                  href={`/whitelist/${event.projectName}/${event.roundName}`}
                  sx={linkStyles}
                >
                  {event.title}
                </Link>

	...
	return (
		<>
			...
			<Grid container spacing={1} sx={{ justifyContent: 'space-between' }}>
				...
				<Grid item xs={6} md={2}>
					...
					<List>
						...
						<ListItem disableGutters sx={listItemStyles}>
							<Link activeClassName='active' href='/contribute/paideia/strategic' sx={linkStyles}>
			...
			<Grid container spacing={1} sx={bottomStyles}>
				...
				<ListItem sx={socialStyles}>
					<Link sx={{ display: 'flex', justifyContent: 'center'  }}  href="https://github.com/ergo-pad" aria-label="Github" title="Github" target="_blank">
						<SvgIcon sx={{ width: '32px', height: '32px' }} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">

...
const DeleteTutorialForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (errorCheck) {
      ...
      try {
        await axios.delete(
          `${process.env.API_URL}/tutorials/${id}`,
          defaultOptions
        );
        setOpenSuccess(true);
      ...
      <Box component="form" onSubmit={handleSubmit}>
        ...
        <Grid item xs={12}>
          <Typography color="text.secondary" sx={{ mt: 2, mb: 1 }}>
            Enter tutorial id manually or select one from the table below. This
...
export default DeleteTutorialForm;
